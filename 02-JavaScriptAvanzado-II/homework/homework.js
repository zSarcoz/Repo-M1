...
function getNombre(){
 ...
 // Escribir código, sin modificar lo que ya se encuentra escrito arriba,
 // para poder llamar al método getNombre para obtener primero el nombre del 
 //instructor y luego para obtener el nombre del alumno.
...
y el delimitador especificado. La idea es realizarlo con la función bind para poder volver a utilizarlo múltiples 
veces luego:
...
Esto nos va a permitir llamar por ejemplo al método "textoAsteriscos" únicamente pasándole un argumento en vez
 de los tres que recibe "crearCadena"
*/
